...
const DEFAULT_TITLE = ''
const DEFAULT_TITLE_TEMPLATE = 'Mealprep | %s'
const DEFAULT_DESCRIPTION = 'Your one-stop for all mealprep needs'
const DEFAULT_CANONICAL = getURL()
const SITE_NAME = 'Mealprep'
const DEFAULT_OG_IMAGE = `${DEFAULT_CANONICAL}/preview.png`
const TWITTER_HANDLE = '@skolldev'
